...
provider boundary and remain null in Akshar's ranked results and audits. The
legacy scoring policy still omits unknown transfer cost and reports that limit;
never present an unknown count as an observed zero-transfer journey.
