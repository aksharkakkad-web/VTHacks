...
**September 19 pivot:** start with [what changes](Beacon_Pivot_What_Changes.md)
and [Mahin / Rishit / Akshar updates](Beacon_Pivot_Updates_To_Do.md). The kickoff
checklists below are historical; they do not describe current implementation status.
